...
* [Chit Chart](https://chitchart.com/) - chitchart.com | Let's talk about facts
...
* Cole Nussbaumer Knaflic
    ...
    * [transform: a storytelling with data mini-workshop](https://www.youtube.com/watch?v=PoGv0dViLAo)
* Neil Halloran
...
* Quotes
    ...
    * KWYs -- Bill Shander
        ...
        * The "so what" (the story in the data) is what your audience is there for, not the actual data points themselves.
